...
def main(target_language: str):
    ...
    for n_shots in shot_configs:
        run(f'gemma4b_{n_shots}_shot.txt', n_shots, eng_lines, None, tgt_lines, None, target_language, directory)
        run(f'gemma4b_{n_shots}_shot_umr.txt', n_shots, eng_lines, umr_lines, tgt_lines, 'Uniform Meaning Representation', target_language, directory)
        run(f'gemma4b_{n_shots}_shot_amr.txt', n_shots, eng_lines, amr_lines, tgt_lines, 'Abstract Meaning Representation', target_language, directory)
