...
def main(target_language: str):
    ...
    for n_shots in shot_configs:
        run(f'aya_{n_shots}_shot_umr.txt', n_shots, eng_lines, umr_descriptions, tgt_lines, 'Uniform Meaning Representation', target_language, directory)
        run(f'aya_{n_shots}_shot_amr.txt', n_shots, eng_lines, amr_descriptions, tgt_lines, 'Abstract Meaning Representation', target_language, directory)
